...
export class HeaderComponent implements OnInit {
  ...
  openModal(name: string) {
    ...
    if (name === 'login') {
      ...
      this.modalTitle.nativeElement.textContent = 'Ingrese la información de inicio de sesión';
    }
    if (name === 'register') {
      componentType = RegisterComponent;
      this.modalTitle.nativeElement.textContent = 'Ingrese la información de registro';
    }
